...
public class ExcelValidatorConstant {
	...
	public static final String EXCEL_CUSTOM_METHOD_VALIDATOR = "CustomMethodValidatorI";
	
	public static final String EXCEL_REQUIRED_VALIDATOR = "RequiredValidator";
	
	public static final String EXCEL_UNIQUE_VALIDATOR = "UniqueValidatorI";
	
	public static final String EXCEL_LENGTH_VALIDATOR = "LengthValidatorI";
	
	public static final String EXCEL_EMAIL_VALIDATOR = "EmailValidatorI";
	
	public static final String EXCEL_PATTERN_VALIDATOR = "PatternValidatorI";
	
	public static final String EXCEL_NUMERIC_VALIDATOR = "NumericValidatorI";
	
	public static final String EXCEL_ALPHANUMERIC_VALIDATOR = "AlphaNumericValidatorI";
	
	public static final String EXCEL_CONDITIONAL_VALIDATOR = "ConditionalValidatorI";
