...
public class NoTemplateMultiOrientedRandomPositionTest4 {
    public static void main(String[] args) throws Exception {
        ...
        ExcelSheetContext excelSheetContext = ExcelSheetContext
                .builder()
                .filePath(filePath)
                .fileName("NoTemplateMultiOrientedRandomPositionTest4.xlsx")
                .build();
        List<List<? extends BaseSheet>> multiOrientedSheets = List.of(CompanyInfoAndUserInfoMultiOrientedNoTemplateRandomPositionVerticalSheetMock.generateMultiOrientedCompanyInfoVerticalSheets(), CompanyInfoAndUserInfoMultiOrientedNoTemplateRandomPositionVerticalSheetMock.generateMultiOrientedUserInfoVerticalSheets());
