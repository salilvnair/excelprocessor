...
public class WithTemplateVerticalSheetTest {

    public static void main(String[] args) throws Exception {
        String filePath = "/Users/salilvnair/workspace/git/salilvnair/excelprocessor/src/main/resources/excel/generated";
        String templateFilePath = "/Users/salilvnair/workspace/git/salilvnair/excelprocessor/src/main/resources/excel/template/TemplateVerticalSheetTest.xlsx";
        ...
        ExcelSheetContext excelSheetContext = ExcelSheetContext
                ...
                .fileName("WithTemplateVerticalSheetTest.xlsx")
                .build();
