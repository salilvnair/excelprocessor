...
import com.github.salilvnair.excelprocessor.v2.test.sheet.multioriented.withtemplate.CompanyInfoMultiOrientedHorizontalDynamicSheet;
import com.github.salilvnair.excelprocessor.v2.test.sheet.multioriented.withtemplate.CompanyInfoMultiOrientedHorizontalSheet;
import com.github.salilvnair.excelprocessor.v2.test.sheet.multioriented.withtemplate.UserInfoMultiOrientedHorizontalDynamicSheet;
import com.github.salilvnair.excelprocessor.v2.test.sheet.multioriented.withtemplate.UserInfoMultiOrientedHorizontalSheet;

import java.util.LinkedHashMap;
import java.util.List;

public class CompanyInfoAndUserInfoMultiOrientedWithTemplateHorizontalSheetMock {
    ...
    private static List<CompanyInfoMultiOrientedHorizontalDynamicSheet> companyInfoMultiOrientedDynamicHorizontalSheets(List<CompanyInfoMock.CompanyInfo> companyInfos) {
        return companyInfos.stream()
                .map(CompanyInfoAndUserInfoMultiOrientedWithTemplateHorizontalSheetMock::generateHorizontalDynamicHeaders)
                .toList();
    }
    ...
    private static List<CompanyInfoMultiOrientedHorizontalSheet> companyInfoMultiOrientedHorizontalSheets(List<CompanyInfoMock.CompanyInfo> companyInfos) {
        return companyInfos.stream()
                .map(CompanyInfoAndUserInfoMultiOrientedWithTemplateHorizontalSheetMock::createCompanyInfoMultiOrientedHorizontalSheet)
                .toList();
    }
   ...
   public static List<UserInfoMultiOrientedHorizontalDynamicSheet> generateMultiOrientedUserInfoHorizontalDynamicSheets() {
    ...
    private static List<UserInfoMultiOrientedHorizontalSheet> userInfoMultiOrientedHorizontalSheets(List<UserInfoMock.UserInfo> userInfos) {
        return userInfos.stream()
                .map(CompanyInfoAndUserInfoMultiOrientedWithTemplateHorizontalSheetMock::createUserInfoMultiOrientedHorizontalSheet)
                .toList();
    }
