...
import com.github.salilvnair.excelprocessor.v2.processor.provider.reader.DynamicHeaderHorizontalSheetReader;
 ...
 * @author Salil V Nair
 */
public class DynamicHeaderHorizontalSheetReaderConcurrentServiceImpl extends DynamicHeaderHorizontalSheetReader implements SheetReaderConcurrentService {
    public DynamicHeaderHorizontalSheetReaderConcurrentServiceImpl(boolean concurrent, int batchSize) {
