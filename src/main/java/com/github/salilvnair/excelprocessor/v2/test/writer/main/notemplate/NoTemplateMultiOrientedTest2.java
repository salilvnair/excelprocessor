...
public class NoTemplateMultiOrientedTest2 {
    public static void main(String[] args) throws Exception {
        ...
        ExcelSheetContext excelSheetContext = ExcelSheetContext
                .builder()
                .filePath(filePath)
                .fileName("NoTemplateMultiOrientedTest2.xlsx")
                .build();
        List<List<? extends BaseSheet>> multiOrientedSheets = CompanyInfoAndUserInfoMultiOrientedNoTemplateHorizontalSheetMock.generateMultiOrientedHorizontalDynamicSheets();
