...
import com.github.salilvnair.excelprocessor.v2.test.sheet.horizontal.withtemplate.CompanyInfoHorizontalDynamicSheet;
import com.github.salilvnair.excelprocessor.v2.test.sheet.horizontal.withtemplate.CompanyInfoHorizontalSheet;

import java.util.LinkedHashMap;
import java.util.List;

public class CompanyInfoWithTemplateHorizontalSheetMock {
   ...
   public static List<CompanyInfoHorizontalDynamicSheet> generateHorizontalDynamicSheets() {
    ...
    private static List<CompanyInfoHorizontalDynamicSheet> companyInfoDynamicHorizontalSheets(List<CompanyInfoMock.CompanyInfo> companyInfos) {
       return companyInfos.stream()
               .map(CompanyInfoWithTemplateHorizontalSheetMock::generateHorizontalDynamicHeaders)
               .toList();
   }
    ...
    private static List<CompanyInfoHorizontalSheet> companyInfoHorizontalSheets(List<CompanyInfoMock.CompanyInfo> companyInfos) {
        return companyInfos.stream()
                .map(CompanyInfoWithTemplateHorizontalSheetMock::createCompanyInfoHorizontalSheet)
                .toList();
    }
