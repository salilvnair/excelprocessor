...
public class NoTemplateMultiOrientedTest3 {
    public static void main(String[] args) throws Exception {
        ...
        ExcelSheetContext excelSheetContext = ExcelSheetContext
                .builder()
                .filePath(filePath)
                .fileName("NoTemplateMultiOrientedTest3.xlsx")
                .build();
        List<List<? extends BaseSheet>> multiOrientedSheets = List.of(CompanyInfoAndUserInfoMultiOrientedNoTemplateHorizontalSheetMock.generateMultiOrientedCompanyInfoHorizontalSheets(), CompanyInfoAndUserInfoMultiOrientedNoTemplateVerticalSheetMock.generateMultiOrientedUserInfoVerticalSheets());
