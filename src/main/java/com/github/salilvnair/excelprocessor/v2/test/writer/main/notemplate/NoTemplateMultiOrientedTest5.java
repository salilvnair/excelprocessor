...
public class NoTemplateMultiOrientedTest5 {
    public static void main(String[] args) throws Exception {
        ...
        ExcelSheetContext excelSheetContext = ExcelSheetContext
                .builder()
                .filePath(filePath)
                .fileName("NoTemplateMultiOrientedTest5.xlsx")
                .build();
        List<List<? extends BaseSheet>> multiOrientedSheets = List.of(CompanyInfoAndUserInfoMultiOrientedNoTemplateVerticalSheetMock.generateMultiOrientedCompanyInfoVerticalDynamicSheets(), CompanyInfoAndUserInfoMultiOrientedNoTemplateVerticalSheetMock.generateMultiOrientedUserInfoVerticalDynamicSheets());
