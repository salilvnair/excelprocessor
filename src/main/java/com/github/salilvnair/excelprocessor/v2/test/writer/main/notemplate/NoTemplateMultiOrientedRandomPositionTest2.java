...
public class NoTemplateMultiOrientedRandomPositionTest2 {
    public static void main(String[] args) throws Exception {
        ...
        ExcelSheetContext excelSheetContext = ExcelSheetContext
                .builder()
                .filePath(filePath)
                .fileName("NoTemplateMultiOrientedRandomPositionTest2.xlsx")
                .build();
        List<List<? extends BaseSheet>> multiOrientedSheets = CompanyInfoAndUserInfoMultiOrientedNoTemplateRandomPositionVerticalSheetMock.generateMultiOrientedVerticalSheets();
