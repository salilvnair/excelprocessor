...
public class UserDefinedTemplateDynamicHorizontalSheetWriter extends BaseHorizontalSheetWriter {
    ...
    void write(List<? extends BaseSheet> sheetData, ExcelSheetWriterContext writerContext) {
        ...
        writeUserDefinedTemplateDynamicDataToBody(sheetData, workbookSheet, sheet, writerContext);
