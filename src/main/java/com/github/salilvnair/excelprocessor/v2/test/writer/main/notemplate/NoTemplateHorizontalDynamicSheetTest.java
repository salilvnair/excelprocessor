...
public class NoTemplateHorizontalDynamicSheetTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ExcelSheetContext excelSheetContext = ExcelSheetContext
                .builder()
                .filePath(filePath)
                .fileName("HorizontalDynamicSheetTest.xlsx")
                .build();
        Workbook workbook = writer.workbook(CompanyInfoNoTemplateHorizontalSheetMock.generateHorizontalDynamicSheets(), excelSheetContext);
