...
import com.github.salilvnair.excelprocessor.v2.processor.provider.reader.SectionTypeVerticalSheetReader;
 ...
 * @author Salil V Nair
 */
public class VerticalSectionSheetReaderConcurrentServiceImpl extends SectionTypeVerticalSheetReader implements SheetReaderConcurrentService {
    public VerticalSectionSheetReaderConcurrentServiceImpl(boolean concurrent, int batchSize) {
